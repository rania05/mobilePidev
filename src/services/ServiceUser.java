...
//            u.setNom(obj.get("nom").toString());
    ...
    public Utilisateur getUserData(int user_id) {
      ...
      //  con.setUrl("http://localhost/Maddox_heart2hold/web/app_dev.php/user/getuserid/" + user_id);
        con.setUrl("http://localhost/Maddox_heart2hold%20(1)/Maddox_heart2hold/web/app_dev.php/user/getuserid/" + user_id);
    ...
    public Utilisateur CheckLoginData(String username, String password) {
        ...
        //con.setUrl("http://localhost/Maddox_heart2hold/web/app_dev.php/user/checklogindata/username/" + username + "/password/" + password);
           con.setUrl("http://localhost/Maddox_heart2hold%20(1)/Maddox_heart2hold/web/app_dev.php/user/checklogindata/username/" + username + "/password/" + password);
